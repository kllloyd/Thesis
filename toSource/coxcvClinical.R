...
coxcvClinical <- function(x.train,y.train, x.test, y.test, useLASSO=TRUE) {
  source("../toSource/lassoSurv.R")
        ...
        c.index.predict <- estC(scoreY=cox.predict, timeX=y.test[,1], statusX=y.test[,2])
